...
#loss_fn = nn.CrossEntropyLoss()
    ...
    for epoch in range(epochs):
        ...
        test_loader = XY_data_loader_toz_800_v2_sza_test(pre_list, alb_list,
                raa_list, vza_list, sza_list, toz_list, 
...
#test_loader
        ...
        #for batch_idx, (f_plot, r_plot) in enumerate(valid_loader):
            ...
            ##if i % 10 == 0:
                ##print(i, outputs)
            #filename = ('./plot/10_rtm_nn_' + lat + '_toz300_epoch_' + str(epoch_local).zfill(5) +
        ...
        torchstatefile = './states_10/10_rtm_nn_sza_test_epoch_' + str(epoch_local).zfill(5) + '.pth'
        #print('torchstatefile')
