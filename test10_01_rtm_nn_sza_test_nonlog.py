...
from ds_rtm_nn import XY_data_loader_toz_800_v3_sza_train
from ds_rtm_nn import XY_data_loader_toz_800_v3_sza_test
...
#loss_fn = nn.CrossEntropyLoss()
    ...
    _epoch_list = []
    for (path, dir, files) in os.walk('./states_10_01/'):
    ...
    if len(files) >= 1:
        torchstatefile = './states_10_01/' + sorted(files)[-1]
    ...
    for epoch in range(epochs):
        ...
        train_loader = XY_data_loader_toz_800_v3_sza_train(pre_list_train,
        ...
        test_loader = XY_data_loader_toz_800_v3_sza_test(pre_list_test,
        ...
        for i, (features, radiances) in enumerate(train_loader):
            ...
            if epoch_local % 100 == 0:
                for inbatch in range(12):
                    #print(i, outputs)
                    filename = ('./plot/10_01_rtm_nn_nl24_' + lat + '_toz300_epoch_' + str(epoch_local).zfill(8) +
...
#test_loader
        ...
        lossesfile = './result/10_01_rtm_nn_sza_test_nonlog_mean_losses.txt' 
        #print('lossesfile')
        ...
        torchstatefile = './states_10_01/10_rtm_nn_sza_test_epoch_' + str(epoch_local).zfill(8) + '.pth'
        if epoch_local % 100 == 0:
